...
- [ ] Update ORM/schema serialization for new status/column.
- [ ] Add backend tests for new enum persistence.
- [ ] Add backend tests for nullable direction linkage persistence.
- [ ] Verify existing goal paths remain unchanged for active goal types.
