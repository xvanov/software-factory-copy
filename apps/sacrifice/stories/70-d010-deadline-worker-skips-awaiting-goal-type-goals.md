# Story
## Title
D010 deadline worker skips awaiting_goal_type goals

## Story
As a backend engineer,
I want deadline enforcement to ignore goals awaiting generated verifier types,
so that inactive generated goals are never charged or enforced before activation.
...
## Tasks / Subtasks
- [ ] Update deadline worker query/selection logic to exclude `awaiting_goal_type` goals.
- [ ] Add regression tests proving pending generated goals are skipped by enforcement/charging paths.
- [ ] Confirm no change to handling of existing active or other enforceable states.
- [ ] Verify behavior aligns with story 1 persistence changes.
