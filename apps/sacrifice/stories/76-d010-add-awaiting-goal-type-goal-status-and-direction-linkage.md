...
- [ ] Add nullable `awaiting_direction_id` column to `goals`
- [ ] Generate Alembic migration via autogenerate
- [ ] Update ORM/model serialization for new status and field
- [ ] Add tests covering persistence of pending generated goal linkage
- [ ] Verify existing goal creation paths remain valid
...
- Note: `context/current-state.md` and `context/modules/*.md` referenced in navigation were not present in the provided prelude; do not invent sections.
