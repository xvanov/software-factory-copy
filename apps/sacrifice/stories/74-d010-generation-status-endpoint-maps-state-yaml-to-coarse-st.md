# Story 1.1: D010 generation-status endpoint maps state.yaml to coarse states

Status: ready-for-dev

## Story

As a user, I want d010 generation-status endpoint maps state.yaml to coarse states, so that the documented outcome holds.
