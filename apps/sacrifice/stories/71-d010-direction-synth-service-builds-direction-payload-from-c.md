# Story 1.1: D010 direction_synth service builds direction payload from chat

Status: ready-for-dev

## Story

As a user, I want d010 direction_synth service builds direction payload from chat, so that the documented outcome holds.
